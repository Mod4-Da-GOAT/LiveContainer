...
var body: some View {
    Form {
        ...
        settingsFixesSection
        settingsURLSchemesSection
...
@ViewBuilder private var settingsSecuritySection: some View {
...
@ViewBuilder private var settingsJITSection: some View {
    Section {
...
@ViewBuilder private var settingsLockSection: some View {
    Section {
...
@ViewBuilder private var settingsLanguageSection: some View {
    Section {
            NavigationLink {
...
@ViewBuilder private var settingsFixesSection: some View {
    Section {
...
@ViewBuilder private var settingsURLSchemesSection: some View {
    Section {
...
@ViewBuilder private var settingsStatsSection: some View {
    Section {
            HStack {
